...
# Terraform Validate
# -------------------------------------------------------------------------------------------------------
# Run Terraform Validate on the TF_CONFIG_DIRECTORY directory.
# This is to check the consistency of the Terraform code in the TF_CONFIG_DIRECTORY.
#
# -------------------------------------------------------------------------------------------------------
set -euo pipefail
...
#echo -e "${DEF_COLOR}### Listing Terraform providers..."
#./terraform providers

# Building the terraform CMD to execute
export CMD="./terraform validate -compact-warnings"

echo -e "${DEF_COLOR}### Calling terraform VALIDATE from [tfdir]"
